                ...
                return moviesItem(
                  ...
                  onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) =>
                            MovieDetail(movie: snapshot.data.results[index]),
                      ),
                    );
                  },
                );
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          children: <Widget>[
                            Icon(Icons.calendar_today, size: 12), // Icon
...
class MovieDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(child: Text(movie.overview)),
    );
  }
}
